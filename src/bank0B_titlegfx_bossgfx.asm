...
; Originally Mantis Ant would rely on the enemies of the previous screen to
; load its explosion projectile. This meant that if you saved and reloaded
; on its screen then it wouldn't have the graphics loaded.
; It can't be given a projectile of its own without it using it against the
; player.
bossGfxMantisAnt:
    INCBIN "projectile/fire.bin"
