...
;@gfximg name=enemy/duke_ill width=2 height=2
gfxNpcDukeIll:
    INCBIN "npc/duke_ill.bin"                          ;; 0a:5a80

;@gfximg name=enemy/duke_dead width=2 height=2
gfxNpcDukeDead:
    INCBIN "npc/duke_dead.bin"                         ;; 0a:5ac0
