...
; Used for the airship switch room with werewolfs to prevent a softlock.
script_0553:
    sIF_TRIGGERED_ON_BY $c9
      sSFX 24
      sSET_ROOM_TILE $02, 8, 6
      sSET_ROOM_TILE $00, 2, 1 ; Open an escape route to prevent softlock on save.
    sENDIF
    sEND                                               ;; 0e:5df4 $00
